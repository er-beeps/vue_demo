<template>
  <div>
    ...
    <ul class="pagination">
      ...
      >
        <a
          class="page-link"
          href="#"
          @click="fetchDevelopers(pagination.prev_page_url)"
          >Previous</a
        >
      </li>
      ...
      >
        <a
          class="page-link"
          href="#"
          @click="fetchDevelopers(pagination.next_page_url)"
          >Next</a
        >
      </li>
    </ul>
    ...
    >
      ...
      <button @click="editDeveloper(developer)" class="btn btn-warning mb-2">
        Edit
      </button>
      <button @click="deleteDeveloper(developer.id)" class="btn btn-danger">
        Delete
      </button>
    </div>
  </div>
